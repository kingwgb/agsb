...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "laowang"         # 用户名
UUID = "48068783-10ef-47c7-a52e-3398726aef8e"                     # UUID，留空则自动生成
PORT = 58588                   # Vmess端口，留空或0则自动生成
DOMAIN = "wc.kingwgb.ggff.net"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiY2YzNTMxZWMyODZjZTIxMWRhMDU1YjQ5YzZjYTljNTEiLCJ0IjoiNGZlMTA3NmQtNTE0Mi00MjEzLWI2NmItZTIyZjVkNjI2YzBkIiwicyI6IllUWTBNamhoTldJdFlUVm1OaTAwTmpWaUxUZ3haalV0WmpZeE0yWTJaamhrWkdJdyJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
